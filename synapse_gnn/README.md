...
While testing the custom MLP decoder, I ran an A/B test to see how the model performs with two different types of base graphs (using a 30,000nm spatial quarantine):
1. **The ADP Graph:** Only connects neurons if they physically touch (based on mesh surface area).
